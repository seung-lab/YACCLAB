...
#ifndef YACCLAB_LABELING_PHANTOM_FSM_6C_H_
#define YACCLAB_LABELING_PHANTOM_FSM_6C_H_
...
class PHANTOM_FSM6C : public Labeling3D<Connectivity3D::CONN_6> {
public:
	PHANTOM_FSM6C() {}
...
#endif // !YACCLAB_LABELING_PHANTOM_FSM_6C_H_