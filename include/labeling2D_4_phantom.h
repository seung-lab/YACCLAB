...
#ifndef YACCLAB_LABELING_2D_4_PHANTOM_H_
#define YACCLAB_LABELING_2D_4_PHANTOM_H_
...
class PHANTOM_2D_4 : public Labeling2D<Connectivity2D::CONN_4> {
public:
    PHANTOM_2D_4() {}
        ...
        for (int r = 0; r < h; ++r) {
            ...
            for (int c = 0; c < w; ++c) {
                if (img_row[c] == 0) {
                    ...
                    if (r > 0 && img_row_prev[c] > 0 && !img_row_prev[c-1]) {
...
#endif // !YACCLAB_LABELING_2D_4_PHANTOM_H_