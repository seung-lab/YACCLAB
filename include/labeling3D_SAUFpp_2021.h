...
#ifndef YACCLAB_LABELING3D_SAUFPP_H_
#define YACCLAB_LABELING3D_SAUFPP_H_
...
class SAUFpp_3D : public Labeling3D<Connectivity3D::CONN_26> {
public:
    SAUFpp_3D() {}
...
#include "labeling3D_SAUFpp_2021_tree.inc.h"
...
#undef CONDITION_X
    ...
    void PerformLabeling()
    {
        ...
        //Conditions:
#define CONDITION_A c > 0 && r > 0 && s > 0 && img_slice11_row11[c - 1] > 0
#define CONDITION_B r > 0 && s > 0 && img_slice11_row11[c] > 0
#define CONDITION_C c < w - 1 && r > 0 && s > 0 && img_slice11_row11[c + 1] > 0
#define CONDITION_D c > 0 && s > 0 && img_slice11_row00[c - 1] > 0
#define CONDITION_E s > 0 && img_slice11_row00[c] > 0
#define CONDITION_F c < w - 1 && s > 0 && img_slice11_row00[c + 1] > 0
#define CONDITION_G c > 0 && r < h - 1 && s > 0 && img_slice11_row01[c - 1] > 0
#define CONDITION_H r < h - 1 && s > 0 && img_slice11_row01[c] > 0
#define CONDITION_I c < w - 1 && r < h - 1 && s > 0 && img_slice11_row01[c + 1] > 0
#define CONDITION_J c > 0 && r > 0 && img_slice00_row11[c - 1] > 0
#define CONDITION_K r > 0 && img_slice00_row11[c] > 0
#define CONDITION_L c < w - 1 && r > 0 && img_slice00_row11[c + 1] > 0
#define CONDITION_M c > 0 && img_slice00_row00[c - 1] > 0
...
#endif // YACCLAB_LABELING3D_SAUFPP_H_