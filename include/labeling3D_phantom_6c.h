...
#ifndef YACCLAB_LABELING_PHANTOM_6C_H_
#define YACCLAB_LABELING_PHANTOM_6C_H_
...
class PHANTOM6C : public Labeling3D<Connectivity3D::CONN_6> {
public:
	PHANTOM6C() {}
...
#endif // !YACCLAB_LABELING_PHANTOM_6C_H_