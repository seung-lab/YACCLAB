...
#ifndef YACCLAB_LABELING_PRED_3D_H_
#define YACCLAB_LABELING_PRED_3D_H_
...
class PRED_3D : public Labeling3D<Connectivity3D::CONN_26> {
public:
	PRED_3D() {}
...
#define CONDITION_X img_slice00_row00[c] > 0
            ...
            // First line of the current slice
            {
                ...
                int c = -1;
                goto fl_tree_0;
#include "labeling3D_PRED_2021_fl_forest.inc.h"
            }
            ...
            for (int r = 1; r < h; r++) {
                ...
                int c = -1;
                goto ll_tree_0;
#include "labeling3D_PRED_2021_ll_forest.inc.h"
...
#include "labeling3D_PRED_2021_fl_forest.inc.h"
			...
			for (int r = 1; r < h - 1; r++) {
                ...
                int c = -1;
                goto cl_tree_0;
#include "labeling3D_PRED_2021_cl_forest.inc.h"
...
#endif // !YACCLAB_LABELING_PRED_3D_H_